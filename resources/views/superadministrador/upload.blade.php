...
<a class="flex items-center border-l-4 border-[#001360] bg-slate-200/50 dark:bg-slate-800/50 text-[#001360] dark:text-blue-300 font-bold px-6 py-4 transition-all duration-200" href="{{ route('superadministrador.upload.index') }}">
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <section class="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6 sm:p-8">
                    <div class="max-w-3xl mx-auto">
                        <form action="{{ route('superadministrador.upload.load') }}" method="POST" enctype="multipart/form-data">
                            @csrf
