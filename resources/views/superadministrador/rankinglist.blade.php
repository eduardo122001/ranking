...
<a class="flex items-center border-l-4 border-[#001360] bg-slate-200/50 dark:bg-slate-800/50 text-[#001360] dark:text-blue-300 font-bold px-6 py-4 transition-all duration-200" href="{{ route('superadministrador.ranking.index') }}">
...
<div class="flex items-center gap-2">
    ...
    <h2 class="font-[Manrope] font-extrabold text-[#001360] dark:text-blue-100 text-2xl tracking-tight">Ranking</h2>
</div>
...
<div class="flex flex-wrap items-center justify-between gap-4 mb-8">
    ...
    <form method="GET"
          action="{{ route('superadministrador.ranking.index') }}"
