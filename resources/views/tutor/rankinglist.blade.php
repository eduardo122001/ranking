...
<a class="flex items-center border-l-4 border-[#001360] bg-slate-200/50 dark:bg-slate-800/50 text-[#001360] dark:text-blue-300 font-bold px-6 py-4 transition-all duration-200" href="{{ route('tutor.ranking.index') }}">
...
<div class="flex items-center gap-2">
    <img src="{{ asset('images/cedhi.png') }}" alt="CEDHI" class="w-32 h-30 rounded-lg">
...
<div class="flex flex-wrap items-center justify-between gap-4 mb-8">
    ...
    <form method="GET"
          action="{{ route('tutor.ranking.index') }}"
